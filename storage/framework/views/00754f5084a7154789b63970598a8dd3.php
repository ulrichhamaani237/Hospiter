<header class=" bg-white shadow-md rounded-md w-full text-sm py-4 px-6">
    ...
    <nav class=" w-ful flex items-center  justify-between" aria-label="Global">
        ...
        <div class="flex items-center gap-4">
            <a href="#" class=" bg-pink-200 w-28 h-8 p-5 rounded-2xl flex items-center justify-center text-center font-medium hover:transition-all hover:bg-pink-700" aria-current="page">Button</a>
    ...
    <!-- ========== END HEADER ========== -->
</header><?php /**PATH /home/ulrich/Documents/laravels/Hospiter/resources/views/admin/body/header.blade.php ENDPATH**/ ?>
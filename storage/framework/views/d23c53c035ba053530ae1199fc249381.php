      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-0 gap-y-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-0 gap-y-6">
                                   ...
                                   <div class="card-body">
                                         ...
                                         <div class="relative overflow-x-auto">
                                          ...
                                          <div class="flex gap-6 items-center">
                                                                       <div class="h-12 w-12 inline-block"><img src="@webRoot/assets/images/profile/user-1.jpg" alt="" class="rounded-full w-100"></div>
                                            ...
                                            <h3 class="font-medium">$150/hour</h3>
                                                           ...
                                                           <tr>
                                                                 <td class="p-4 text-sm">
                                          <div class="flex gap-6 items-center">
                                                                       <div class="h-12 w-12 inline-block"><img src="@webRoot/assets/images/profile/user-2.jpg" alt="" class="rounded-full w-100"></div>
                                                                       <div class="flex flex-col gap-1 text-gray-500">
                                            ...
                                            <h3 class="font-medium">$150/hour</h3>
                                                           ...
                                                           <tr>
                                                                 <td class="p-4 text-sm">
                                          <div class="flex gap-6 items-center">
                                                                       <div class="h-12 w-12 inline-block"><img src="@webRoot/assets/images/profile/user-3.jpg" alt="" class="rounded-full w-100"></div>
                                                                       <div class="flex flex-col gap-1 text-gray-500">
                                            ...
                                            <h3 class="font-medium">$150/hour</h3>
                                                           ...
                                                           <tr>
                                                                 <td class="p-4 text-sm">
                                          <div class="flex gap-6 items-center">
                                                                       <div class="h-12 w-12 inline-block"><img src="@webRoot/assets/images/profile/user-4.jpg" alt="" class="rounded-full w-100"></div>
                                                                       <div class="flex flex-col gap-1 text-gray-500">
             ...
             <div class="card overflow-hidden">
                             <div class="relative">
                                   <a href="javascript:void(0)">
                                         <img src="@webRoot/assets/images/products/product-1.jpg" alt="product_img" class="w-full">
                                   </a>
             ...
             <div class="card overflow-hidden">
                             <div class="relative">
                                   <a href="javascript:void(0)">
                                         <img src="@webRoot/assets/images/products/product-2.jpg" alt="product_img" class="w-full">
                                   </a>
                                   <a href="javascript:void(0)" class="bg-blue-600 w-8 h-8 flex justify-center items-center text-white rounded-full absolute bottom-0 right-0 mr-4 -mb-3">
                                         <i class="ti ti-basket text-base"></i>
                                   </a>
             ...
             <div class="card overflow-hidden">
                             <div class="relative">
                                   <a href="javascript:void(0)">
                                         <img src="@webRoot/assets/images/products/product-3.jpg" alt="product_img" class="w-full">
                                   </a>
                                   <a href="javascript:void(0)" class="bg-blue-600 w-8 h-8 flex justify-center items-center text-white rounded-full absolute bottom-0 right-0 mr-4 -mb-3">
                                         <i class="ti ti-basket text-base"></i>
                                   </a>
             ...
             <div class="card overflow-hidden">
                             <div class="relative">
                                   <a href="javascript:void(0)">
                                         <img src="@webRoot/assets/images/products/product-4.jpg" alt="product_img" class="w-full">
                                   </a>
                                   <a href="javascript:void(0)" class="bg-blue-600 w-8 h-8 flex justify-center items-center text-white rounded-full absolute bottom-0 right-0 mr-4 -mb-3">
                                         <i class="ti ti-basket text-base"></i>
                                   </a>
...
<?php echo $__env->make('admin.admin_hospyter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ulrich/Documents/laravels/Hospiter/resources/views/index.blade.php ENDPATH**/ ?>